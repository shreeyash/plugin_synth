package dev.shreeyash.plugin_synth;
...
/** PluginSynthPlugin */
public class PluginSynthPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  private Synth synth;
  private static final String channelName = "plugin_synth";

  private static void setup(PluginSynthPlugin plugin, BinaryMessenger binaryMessenger){
